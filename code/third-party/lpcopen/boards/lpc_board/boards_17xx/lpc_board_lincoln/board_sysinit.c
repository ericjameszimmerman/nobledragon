...
STATIC const PINMUX_GRP_T pinmuxing[] = {
    // TXD3 / RXD3 are COM2 on the schematics (aka Debug Port)
	{0,  0,   IOCON_MODE_INACT | IOCON_FUNC2},	/* TXD3 */
	{0,  1,   IOCON_MODE_INACT | IOCON_FUNC2},	/* RXD3 */
    
    // TXD0 / RXD0 are COM1 on the schematics (our Modbus RTU slave port)
	{0,  2,   IOCON_MODE_PULLUP | IOCON_FUNC1},	/* TXD0 */
	{0,  3,   IOCON_MODE_PULLUP | IOCON_FUNC1},	/* RXD0 */
    
	{0,  21,  IOCON_MODE_PULLUP | IOCON_FUNC3},	/* CAN-RD1 */
	{0,  22,  IOCON_MODE_PULLUP | IOCON_FUNC3},	/* CAN-TD1 */
	/* ENET */
